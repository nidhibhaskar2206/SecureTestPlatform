...
export const sessionStart = async (req, res) => {
  try {
    ...
    console.log(
      "🔹 Received request to create session for TestID:",
      testId,
      "UserID:",
      userId
    );
    ...
    console.log(
      "✅ Session created successfully with PENDING status:",
      session.id
    );
...
export const updateStatus = async (req, res) => {
  try {
    ...
    console.log(
      "🔹 Received request to update session for TestID:",
      testId,
      "UserID:",
      userId
    );
    ...
    res
      .status(200)
      .json({ message: "Session status updated", session: updatedSession });
  } catch (error) {
...
export const getSession = async (req, res) => {
  try {
    ...
    if (sessionId) {
      ...
      return res
        .status(400)
        .json({ error: "Provide sessionId or userId & testId" });
    }
...
export const attemptSession = async (req, res) => {
  try {
